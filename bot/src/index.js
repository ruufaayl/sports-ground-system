...
const GROUND_NAME = process.env.GROUND_NAME || 'Executive Champions Field';
...
// ─── Message templates ────────────────────────────────────────────────────────
const WELCOME_MSG = `👋 *Welcome to ${GROUND_NAME}!*

Book your ground in minutes:
🏟️ Premium Grounds Available
...
async function sendDailyReport(report) {
    ...
    try {
        ...
        const message =
            ...
            `_Auto-generated by ${GROUND_NAME} System_`;
